...
export default function ApplicationSubmitted({ navigate }) {
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", minHeight: "100vh", background: "#f8f9ff" }}>
      ...
      <div style={{ display: "flex" }}>
        ...
        <header style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <span className="material-symbols-outlined" style={{ color: MIDNIGHT, fontSize: 22 }}>check_circle</span>
            <h2 style={{ fontSize: 17, fontWeight: 700, margin: 0, color: "#0f172a" }}>Application Confirmation</h2>
          </div>
        ...
        {/* Scrollable Content */}
        <main style={{ flex: 1, overflowY: "auto", padding: 32, background: "#f8f9ff" }}>
          <div style={{ maxWidth: 720, margin: "0 auto" }}>
            <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #e2e8f0", overflow: "hidden", boxShadow: "0 4px 16px rgba(0,0,0,.06)" }}>
              ...
              {/* Success Hero */}
              <div style={{
                background: MIDNIGHT, padding: "64px 32px", display: "flex",
                ...
                <div style={{
                  ...
                  <span className="material-symbols-outlined" style={{ fontSize: 48, color: "#000", fontVariationSettings: "'FILL' 1" }}>check</span>
                </div>
                <h1 style={{ fontSize: 28, fontWeight: 900, color: "#fff", margin: "0 0 12px" }}>Application Submitted!</h1>
                <p style={{ fontSize: 14, color: "rgba(255,255,255,.7)", maxWidth: 440, lineHeight: 1.7, margin: 0 }}>
              ...
              <div style={{ padding: 32 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 32 }}>
                  {[
                    ...
                    <div key={item.label} style={{ padding: 24, background: "#f8fafc", borderRadius: 12, border: "1px solid #e2e8f0" }}>
                      <p style={{ fontSize: 10, fontWeight: 700, color: "#64748b", textTransform: "uppercase", letterSpacing: "0.12em", margin: "0 0 8px" }}>{item.label}</p>
                ...
                <div style={{ marginBottom: 32 }}>
                  <h3 style={{ fontSize: 17, fontWeight: 700, color: "#0f172a", margin: "0 0 24px" }}>Next Steps</h3>
                      ...
                      {[
                        {
                          ...
                          title: "Application Received", desc: "System has verified all uploaded documents and identity information.",
                          status: "Completed", statusColor: "#16a34a",
                        },
                        {
                          icon: "verified_user", bg: GOLD, color: "#000",
                          title: "Lender Review", desc: "A specialized credit officer is reviewing your credit limit and terms. This usually takes 12-24 hours.",
                          status: "In Progress", statusColor: MIDNIGHT,
                        },
                        {
                          icon: "account_balance_wallet", bg: "#e2e8f0", color: "#94a3b8",
                          title: "Fund Disbursement", desc: "Once approved, funds will be instantly transferred to your linked bank account ending in **4902.",
                          status: "Upcoming", statusColor: "#94a3b8",
                        },
                      ].map((step, i) => (
                        <div key={i} style={{ display: "flex", gap: 24, position: "relative", opacity: step.status === "Upcoming" ? 0.6 : 1 }}>
                          <div style={{
                ...
                <div style={{ display: "flex", gap: 12, paddingTop: 24, borderTop: "1px solid #f1f5f9" }}>
                  <button style={{
                    flex: 1, background: GOLD, color: "#000", height: 48, borderRadius: 12,
                  ...
                  <button
                    ...
                    style={{
                      flex: 1, background: "#f1f5f9", color: "#0f172a", height: 48, borderRadius: 12,
                      fontWeight: 700, fontSize: 14, border: "none", cursor: "pointer",
                      display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
                    }}>

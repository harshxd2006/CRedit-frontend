          ...
          <main style={{ flex: 1, padding: "40px 48px" }} className="page-main">
            <div style={{ maxWidth: 900, margin: "0 auto" }}>
              ...
              <div style={{ marginBottom: 28 }}>
                <h1 style={{ fontSize: 28, fontWeight: 900, color: "#0f172a", margin: "0 0 6px", letterSpacing: "-0.5px" }}>Credit Building Journey</h1>
              ...
              {/* Journey Roadmap */}
              <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #e2e8f0", padding: 28, marginBottom: 24, boxShadow: "0 1px 4px rgba(0,0,0,.04)" }}>
                <h3 style={{ fontSize: 16, fontWeight: 700, color: "#0f172a", margin: "0 0 24px" }}>Journey Roadmap</h3>
              ...
              <div className="score-grid" style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 24, marginBottom: 24 }}>
                <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #e2e8f0", padding: 24, boxShadow: "0 1px 4px rgba(0,0,0,.04)" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
                    <h3 style={{ fontSize: 16, fontWeight: 700, color: "#0f172a", margin: 0 }}>NTC Score History</h3>
                ...
                <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #e2e8f0", padding: 24, boxShadow: "0 1px 4px rgba(0,0,0,.04)" }}>
                  <h3 style={{ fontSize: 16, fontWeight: 700, color: "#0f172a", margin: "0 0 20px" }}>Key Factors</h3>
                  ...
                  <button style={{ width: "100%", marginTop: 20, padding: "10px 0", fontSize: 13, fontWeight: 700, color: MIDNIGHT, background: "rgba(17,66,93,.05)", borderRadius: 8, border: "none", cursor: "pointer" }}>
                    View All Factors
                  </button>
                </div>
              </div>
              ...
              {/* Action Plan */}
              <div>
                <h3 style={{ fontSize: 16, fontWeight: 700, color: "#0f172a", margin: "0 0 16px" }}>Action Plan: Score Boosters</h3>
                <div className="action-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
                  {actionCards.map((card) => (
                    <div key={card.title} style={{ background: "#fff", padding: 20, borderRadius: 14, border: "1px solid #e2e8f0", cursor: "pointer", transition: "border-color .15s, box-shadow .15s" }}
                    ...
                    >
                      ...
                      <p style={{ fontSize: 13, color: "#64748b", lineHeight: 1.6, margin: "0 0 14px" }}>{card.desc}</p>
...
const _cbStyle = document.createElement("style");
_cbStyle.textContent = `
  @media (max-width: 768px) {
          nav, header { padding-right: 60px !important; }
    .page-main   { padding: 24px 16px !important; }
    .score-grid  { grid-template-columns: 1fr !important; }
    .action-grid { grid-template-columns: 1fr !important; }
  }
`;
if (!document.getElementById("creditbuilding-styles")) {
  _cbStyle.id = "creditbuilding-styles";
  document.head.appendChild(_cbStyle);
}
                ...
                <section style={{ background: "#fff", borderRadius: 16, border: "1px solid #e2e8f0", padding: 24, boxShadow: "0 1px 4px rgba(0,0,0,.04)" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    ...
                    <div>
                      ...
                      <textarea value={complaint.description} onChange={(e) => setComplaint({ ...complaint, description: e.target.value })}
                        placeholder="Tell us more about the issue..." rows={4}
                    ...
                    <button style={{ width: "100%", padding: "12px 0", background: GOLD, color: MIDNIGHT, fontWeight: 700, fontSize: 14, borderRadius: 10, border: "none", cursor: "pointer" }}>
                      Submit Complaint
                    </button>
                  </div>
                </section>

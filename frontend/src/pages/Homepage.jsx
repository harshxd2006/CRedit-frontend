...
export default function Homepage({ navigate }) {
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#ffffff", color: "#0f172a" }}>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 32px", height: 80, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <span className="material-symbols-outlined" style={{ fontSize: 32, color: "#FFD700" }}>account_balance_wallet</span>
            <span style={{ fontSize: 24, fontWeight: 900, letterSpacing: "-0.5px", textTransform: "uppercase" }}>CreditFlow</span>
          </div>
          {/* Links */}
          <div style={{ display: "flex", alignItems: "center", gap: 32 }}>
            <a href="#how-it-works" style={{ fontSize: 14, fontWeight: 500, color: "#475569", textDecoration: "none" }}
              onMouseEnter={e => e.target.style.color = "#11425D"}
      ...
      {/* ── HERO ── */}
      <section style={{ padding: "64px 32px 96px", position: "relative", overflow: "hidden" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
            ...
            <h1 style={{ fontSize: 64, fontWeight: 900, lineHeight: 1.1, letterSpacing: "-2px", margin: 0, color: "#0f172a" }}>
              Never Taken a Loan Before?{" "}
              <span>That Shouldn't Stop You.</span>
            </h1>

            <p style={{ fontSize: 17, color: "#475569", maxWidth: 520, lineHeight: 1.75, margin: 0 }}>
            ...
            <div>
              <button
                ...
                style={{
                  padding: "16px 36px", borderRadius: 12, fontWeight: 700, fontSize: 17,
                  background: "#FFD700", color: "#000", border: "none", cursor: "pointer",
            ...
            <div style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                <span style={{ fontWeight: 700, color: "#FFD700", fontSize: 15 }}>100% Free</span>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 4, borderLeft: "1px solid #e2e8f0", borderRight: "1px solid #e2e8f0", paddingLeft: 16 }}>
                <span style={{ fontWeight: 700, color: "#FFD700", fontSize: 15 }}>Bank-Level</span>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 4, paddingLeft: 16 }}>
                <span style={{ fontWeight: 700, color: "#FFD700", fontSize: 15 }}>3 Minutes</span>
          ...
          <div style={{ display: "flex", justifyContent: "center", position: "relative" }}>
            ...
            <div style={{
              background: "#fff", padding: 16, borderRadius: 40,
              boxShadow: "0 32px 80px rgba(0,0,0,.18)",
              border: "8px solid #f1f5f9", maxWidth: 280, width: "100%",
              position: "relative", zIndex: 1,
            }}>
              <div style={{
                aspectRatio: "9/19", background: "#f8fafc", borderRadius: 28,
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <div style={{ width: 32, height: 32, borderRadius: "50%", background: "rgba(255,215,0,.2)" }} />
                </div>
                {/* Score */}
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                  <p style={{ fontSize: 11, color: "#94a3b8", margin: 0 }}>Your Credit Potential</p>
                  <h3 style={{ fontSize: 36, fontWeight: 900, margin: 0 }}>782</h3>
                  <div style={{ height: 8, background: "#e2e8f0", borderRadius: 99, overflow: "hidden" }}>
                    <div style={{ height: "100%", width: "85%", background: "#FFD700", borderRadius: 99 }} />
                  </div>
                  <p style={{ fontSize: 9, fontWeight: 700, color: "#FFD700", margin: 0, letterSpacing: "0.1em" }}>EXCELLENT BEHAVIOR</p>
                </div>
                {/* Cards */}
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  <div style={{
                    ...
                    <div style={{ width: 32, height: 32, borderRadius: 8, background: "#eff6ff", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                      <span className="material-symbols-outlined" style={{ fontSize: 16, color: "#3b82f6" }}>payments</span>
                    </div>
                    <div>
                      <p style={{ fontSize: 10, fontWeight: 700, margin: 0 }}>Rent Payment</p>
                      <p style={{ fontSize: 8, color: "#94a3b8", margin: 0 }}>Consistent &amp; On-time</p>
                    </div>
                  </div>
                  <div style={{
                    padding: "10px 12px", background: "#fff", borderRadius: 12,
                    ...
                    <div style={{ width: 32, height: 32, borderRadius: 8, background: "#f0fdf4", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                      <span className="material-symbols-outlined" style={{ fontSize: 16, color: "#22c55e" }}>bolt</span>
                    </div>
                    <div>
                      <p style={{ fontSize: 10, fontWeight: 700, margin: 0 }}>Utility Bills</p>
                      <p style={{ fontSize: 8, color: "#94a3b8", margin: 0 }}>Zero Delays</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section style={{ padding: "96px 32px", background: "#fff" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <h2 style={{ fontSize: 40, fontWeight: 900, letterSpacing: "-0.5px", margin: "0 0 16px" }}>The Struggle is Real</h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 32, position: "relative" }}>
            {/* dashed line */}
            <div style={{ position: "absolute", top: "50%", left: 0, width: "100%", height: 0, borderTop: "2px dashed #e2e8f0", zIndex: 0 }} />
            {[
              ...
              <div key={c.title} style={{
                ...
                <div style={{ width: 64, height: 64, borderRadius: "50%", background: c.bg, display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <span className="material-symbols-outlined" style={{ fontSize: 32, color: c.color }}>{c.icon}</span>
                </div>
      ...
      <section id="how-it-works" style={{ padding: "96px 32px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", gap: 64, alignItems: "center" }}>
          ...
          <div style={{ flex: "1 1 400px", display: "flex", flexDirection: "column", gap: 24 }}>
            <h2 style={{ fontSize: 48, fontWeight: 900, lineHeight: 1.1, letterSpacing: "-1px", margin: 0 }}>
              Here's How <span>CreditFlow</span> Fixes This
            </h2>
            <p style={{ fontSize: 17, color: "#64748b", lineHeight: 1.75, margin: 0 }}>
              We use alternative data points to build your financial identity from scratch. Your honesty is your credit.
            </p>
              ...
              {[
                ...
                <div key={s.n} style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
                  <div style={{
                    ...
                    justifyContent: "center", fontWeight: 700, fontSize: 17, color: "#11425D",
                  }}>{s.n}</div>
                  <div>
                    <h4 style={{ fontSize: 17, fontWeight: 700, margin: "0 0 6px" }}>{s.title}</h4>
          ...
          <div style={{ flex: "1 1 400px" }}>
            <div style={{
              background: "rgba(255,215,0,.05)", padding: 32, borderRadius: 24,
      ...
      {/* ── COMPARISON TABLE ── */}
      <section style={{ padding: "96px 32px", background: "#11425D", color: "#fff" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <h2 style={{ fontSize: 40, fontWeight: 900, textAlign: "center", marginBottom: 64, letterSpacing: "-0.5px" }}>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left" }}>
              <thead>
                <tr style={{ borderBottom: "1px solid rgba(255,255,255,.20)" }}>
                  <th style={{ padding: "24px 16px", fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.2em", opacity: 0.7 }}>Feature</th>
                  <th style={{ padding: "24px 16px", textAlign: "center", background: "rgba(255,255,255,.10)", borderRadius: "8px 8px 0 0", fontSize: 15, fontWeight: 700 }}>CreditFlow</th>
                  <th style={{ padding: "24px 16px", textAlign: "center", fontSize: 15, fontWeight: 700 }}>Traditional Apps</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ borderBottom: "1px solid rgba(255,255,255,.10)" }}>
                    <td style={{ padding: "24px 16px", fontWeight: 500, fontSize: 14 }}>{row.feature}</td>
                    <td style={{ padding: "24px 16px", textAlign: "center", background: "rgba(255,255,255,.10)", fontWeight: 700, fontSize: 14 }}>{row.cf}</td>
                    <td style={{ padding: "24px 16px", textAlign: "center", opacity: 0.6, fontSize: 14 }}>{row.trad}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <section style={{ padding: "96px 32px", background: "#ffffff" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <h2 style={{ fontSize: 40, fontWeight: 900, margin: 0 }}>Built for the Next Generation</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: 24 }}>
            {[
              ...
              >
                <span className="material-symbols-outlined" style={{ fontSize: 28, color: "#11425D", display: "block", marginBottom: 16 }}>{card.icon}</span>
                <h3 style={{ fontSize: 14, fontWeight: 700, marginBottom: 8, margin: "0 0 8px" }}>{card.title}</h3>
      ...
      {/* ── SECURITY ── */}
      <section id="security" style={{ padding: "96px 32px", background: "#fff" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            {[
              ...
              <div key={s.title} style={{
                padding: "28px 20px", background: "#f8fafc", borderRadius: 16,
                border: "1px solid #f1f5f9", textAlign: "center",
                display: "flex", flexDirection: "column", alignItems: "center", gap: 10,
              }}>
                <span className="material-symbols-outlined" style={{ fontSize: 32, color: "#FFD700" }}>{s.icon}</span>
                <h4 style={{ fontSize: 13, fontWeight: 700, margin: 0 }}>{s.title}</h4>
              </div>
            ))}
          </div>
          {/* Copy */}
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            <h2 style={{ fontSize: 40, fontWeight: 900, margin: 0, letterSpacing: "-0.5px" }}>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 16 }}>
              {[
                ...
                <li key={item} style={{ display: "flex", alignItems: "center", gap: 12, fontSize: 15, fontWeight: 500 }}>
                  <span className="material-symbols-outlined" style={{ color: "#FFD700", fontSize: 22 }}>check_circle</span>
                  {item}
                </li>
              ))}
            </ul>
      ...
      {/* ── PARTNERS ── */}
      <section id="partners" style={{ padding: "64px 32px", background: "#fff" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", textAlign: "center" }}>
          <p style={{ fontSize: 10, fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.2em", color: "#94a3b8", marginBottom: 40 }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 32 }}>
            {[
              ...
              <div key={i} style={{
                background: "#fff", padding: "36px 28px", borderRadius: 28,
                boxShadow: "0 8px 32px rgba(0,0,0,.08)", border: "1px solid #f1f5f9",
                position: "relative",
              }}>
                <div style={{
                  ...
                  fontSize: 28, fontWeight: 900, color: "#11425D", fontFamily: "Georgia, serif",
                  lineHeight: 1,
                }}>"</div>
                <p style={{ fontSize: 14, color: "#475569", fontStyle: "italic", lineHeight: 1.8, marginBottom: 24 }}>"{t.quote}"</p>
                <div style={{ borderTop: "1px solid #f1f5f9", paddingTop: 20, display: "flex", alignItems: "center", gap: 14 }}>
                  <div style={{
      ...
      <section style={{ padding: "96px 32px", background: "#f8fafc" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 48 }}>
            <div>
              <h2 style={{ fontSize: 40, fontWeight: 900, margin: "0 0 8px", letterSpacing: "-0.5px" }}>Knowledge Hub</h2>
              <p style={{ fontSize: 14, color: "#64748b", margin: 0 }}>Learn how to master your credit journey.</p>
            </div>
            <button style={{ display: "flex", alignItems: "center", gap: 4, fontWeight: 700, fontSize: 14, background: "none", border: "none", cursor: "pointer", color: "#0f172a" }}>
              View All
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 32 }}>
            {[
              ...
              >
                <div style={{
                  aspectRatio: "16/9", borderRadius: 16, background: "#e2e8f0",
                  marginBottom: 24, overflow: "hidden",
                  backgroundImage: `url('${b.img}')`, backgroundSize: "cover", backgroundPosition: "center",
                  boxShadow: "0 4px 12px rgba(0,0,0,.08)",
                }} />
                <h3 style={{ fontSize: 20, fontWeight: 700, marginBottom: 8, transition: "color .15s", color: "#0f172a" }}>{b.title}</h3>
      ...
      {/* ── FOOTER ── */}
      <footer style={{ background: "#11425D", color: "#cbd5e1", paddingTop: 80, paddingBottom: 40, borderTop: "1px solid rgba(255,255,255,.08)" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 32px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 48, marginBottom: 64 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <span className="material-symbols-outlined" style={{ fontSize: 28, color: "#FFD700" }}>account_balance_wallet</span>
                <span style={{ fontSize: 22, fontWeight: 900, color: "#fff", textTransform: "uppercase", letterSpacing: "-0.3px" }}>CreditFlow</span>
              </div>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                {["share", "public", "alternate_email"].map(icon => (
                  <div key={icon} style={{
                    ...
                    onMouseEnter={e => { e.currentTarget.style.background = "#FFD700"; e.currentTarget.querySelector("span").style.color = "#000"; }}
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,.08)", paddingTop: 40, marginBottom: 24 }}>
            <div style={{
              background: "rgba(255,255,255,.04)", padding: "24px 32px",
              borderRadius: 16, maxWidth: 896, margin: "0 auto", textAlign: "center",
            }}>
              <p style={{ fontSize: 9, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.2em", color: "#64748b", marginBottom: 12 }}>
                RBI Disclaimer
              </p>
              <p style={{ fontSize: 11, color: "#64748b", lineHeight: 1.8, margin: 0 }}>
                ...
                Approval is subject to lender terms and conditions. We never ask for payments to get a loan approved.
                Report any suspicious calls to our Grievance Officer.
              </p>
            </div>
          </div>

...
export default function LoanDetails({ navigate }) {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#f8f9ff", minHeight: "100vh" }}>
      ...
      {/* Sidebar */}
      <aside style={{
        width: 256, background: MIDNIGHT, display: "flex", flexDirection: "column",
        ...
        <div style={{ padding: "24px 16px", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontSize: 18, fontWeight: 700, color: "#fff" }}>CreditFlow</span>
        </div>
          ...
          {sidebarLinks.map((link) => (
            <a key={link.label} href="#"
              ...
              style={{
                ...
                fontWeight: link.active ? 700 : 500, fontSize: 14,
                borderLeft: link.active ? `4px solid ${MIDNIGHT}` : "4px solid transparent",
              }}
            >
        ...
        <div style={{ padding: "16px", borderTop: "1px solid rgba(255,255,255,.1)" }}>
          <div style={{ background: "rgba(255,255,255,.05)", borderRadius: 10, padding: 14, marginBottom: 12 }}>
            <p style={{ fontSize: 9, fontWeight: 700, color: GOLD, textTransform: "uppercase", letterSpacing: "0.12em", margin: "0 0 6px" }}>Current Progress</p>
            <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11, fontWeight: 700, marginBottom: 6 }}>
              <span style={{ color: "rgba(255,255,255,.7)" }}>Step 4 of 5</span>
              <span style={{ color: GOLD }}>80%</span>
            </div>
            <div style={{ width: "100%", height: 4, background: "rgba(255,255,255,.1)", borderRadius: 99, overflow: "hidden" }}>
              <div style={{ width: "80%", height: "100%", background: GOLD, borderRadius: 99 }} />
            </div>
          </div>
          <a href="#" style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 8, textDecoration: "none", color: "rgba(255,255,255,.6)", fontSize: 14 }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <header style={{
          ...
          padding: "0 32px", height: 64, background: "#fff", borderBottom: "1px solid #e2e8f0",
          flexShrink: 0,
        }}>
          <h1 style={{ fontSize: 18, fontWeight: 700, margin: 0, color: "#0f172a" }}>Configure Loan</h1>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div style={{ width: 40, height: 40, borderRadius: "50%", background: "#e2e8f0", border: `2px solid rgba(255,215,0,.4)` }} />
          </div>
        </header>

        {/* Scrollable Content */}
        <div style={{ flex: 1, overflowY: "auto", padding: "40px 96px" }}>
          <div style={{ maxWidth: 720, margin: "0 auto" }}>

            <div style={{ marginBottom: 32 }}>
              <h2 style={{ fontSize: 28, fontWeight: 900, color: "#0f172a", margin: "0 0 6px", letterSpacing: "-0.5px" }}>Loan Customization</h2>
              <p style={{ fontSize: 14, color: "#64748b", margin: 0 }}>Fine-tune your credit requirements. We'll generate a personalized report based on these parameters.</p>
            </div>

            {/* Loan Amount Slider */}
            <div style={{ background: "#fff", borderRadius: 20, border: "1px solid #e2e8f0", padding: 32, marginBottom: 24, boxShadow: "0 1px 4px rgba(0,0,0,.04)" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24, gap: 16 }}>
                <div>
                  <h3 style={{ fontSize: 17, fontWeight: 700, color: "#0f172a", margin: "0 0 2px" }}>Desired Loan Amount</h3>
                  <p style={{ fontSize: 13, color: "#64748b", margin: 0 }}>Drag to adjust your capital requirement</p>
                </div>
                <div style={{ background: "rgba(17,66,93,.05)", border: "1px solid rgba(17,66,93,.1)", borderRadius: 12, padding: "10px 20px" }}>
                  <span style={{ fontSize: 28, fontWeight: 900, color: MIDNIGHT }}>₹{(loanAmount / 100000).toFixed(1)}L</span>
                </div>
              </div>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                />
                <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11, fontWeight: 700, color: "#94a3b8", textTransform: "uppercase", letterSpacing: "0.1em", marginTop: 6 }}>
                  <span>₹10,000</span>
                  <span>₹5,00,000</span>
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14 }}>
                <div style={{ padding: 14, background: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: 12, textAlign: "center" }}>
                  <p style={{ fontSize: 10, fontWeight: 700, color: "#16a34a", textTransform: "uppercase", margin: "0 0 4px" }}>Estimated EMI</p>
                  <p style={{ fontSize: 20, fontWeight: 700, color: "#15803d", margin: "0 0 2px" }}>₹{emi.toLocaleString()}</p>
                  <p style={{ fontSize: 10, color: "#22c55e", margin: 0 }}>Per Month</p>
                </div>
                <div style={{ padding: 14, background: "rgba(17,66,93,.05)", border: "1px solid rgba(17,66,93,.1)", borderRadius: 12, textAlign: "center" }}>
                  <p style={{ fontSize: 10, fontWeight: 700, color: MIDNIGHT, textTransform: "uppercase", margin: "0 0 4px" }}>Interest Rate</p>
                  <p style={{ fontSize: 20, fontWeight: 700, color: MIDNIGHT, margin: "0 0 2px" }}>10.5%</p>
                  <p style={{ fontSize: 10, color: "#64748b", margin: 0 }}>p.a. Fixed</p>
                </div>
                <div style={{ padding: 14, background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 12, textAlign: "center" }}>
                  <p style={{ fontSize: 10, fontWeight: 700, color: "#94a3b8", textTransform: "uppercase", margin: "0 0 4px" }}>Total Tenure</p>
                  <p style={{ fontSize: 20, fontWeight: 700, color: "#0f172a", margin: "0 0 2px" }}>36 Months</p>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 24 }}>
              <div>
                ...
                <select value={purpose} onChange={(e) => setPurpose(e.target.value)}
                  style={{ width: "100%", height: 48, padding: "0 12px", borderRadius: 8, border: "1px solid #e2e8f0", fontSize: 14, fontFamily: "'Inter', sans-serif", outline: "none" }}>
            ...
            {/* Info Banner */}
            <div style={{ display: "flex", gap: 12, padding: 18, background: "rgba(17,66,93,.05)", border: "1px solid rgba(17,66,93,.1)", borderRadius: 12, marginBottom: 32 }}>
            ...
            {/* Footer CTA */}
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: 24, borderTop: "1px solid #e2e8f0", paddingBottom: 40 }}>
              ...
              <button style={{
                padding: "14px 32px", background: GOLD, color: MIDNIGHT, borderRadius: 12,
                fontWeight: 700, fontSize: 15, border: "none", cursor: "pointer",
                display: "flex", alignItems: "center", gap: 10,
                boxShadow: "0 6px 20px rgba(255,215,0,.3)",

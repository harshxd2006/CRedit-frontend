            ...
            <div style={{ maxWidth: 896, margin: "0 auto" }}>
              ...
              <div style={{ display: "flex", gap: 32, alignItems: "flex-start" }}>
                ...
                <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: 24 }}>
                  ...
                  <div style={{ background: "#fff", borderRadius: 16, border: "1px solid rgba(17,66,93,.1)", overflow: "hidden", boxShadow: "0 1px 4px rgba(0,0,0,.04)" }}>
                    ...
                    <div style={{ padding: 24 }}>
                      ...
                      <div style={{ paddingTop: 20, borderTop: "1px solid #f1f5f9" }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: 16, background: MIDNIGHT, borderRadius: 10, color: "#fff" }}>
                          <div>
                  ...
                  {/* Cooling-off */}
                  <div style={{ background: "#fffbeb", border: "1px solid #fef3c7", borderRadius: 12, padding: 20, display: "flex", gap: 14 }}>
                          ...
                          <div style={{ display: "flex", gap: 8 }}>
                            {otp.map((v, i) => (
                              <input key={i} ref={(el) => (otpRefs.current[i] = el)}
                                ...
                                style={{ flex: 1, minWidth: 0, height: 48, textAlign: "center", fontSize: 20, fontWeight: 700, border: "1px solid #e2e8f0", borderRadius: 8, background: "#f8fafc", color: "#0f172a", fontFamily: "'Inter', sans-serif", outline: "none", boxSizing: "border-box" }}
